...
export const zFilters = z.record(zFilterValue).optional().describe("Фильтры {поле: значение | [значения]}. Число — точное равенство, текст — поиск подстроки, дата YYYY-MM-DD — точное совпадение. Префиксы ключа: \"!поле\" (не равно), \">поле\" (>=), \"<поле\" (<=), напр. {\">pub_date\": \"2026-01-01\"}");
